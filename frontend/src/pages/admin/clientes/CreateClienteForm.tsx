...
const CreateClienteForm = () => {
	const { register, handleSubmit, errors } = useCreateCliente()

	return (
		<>
			<HeadingTitle>Crear Cliente</HeadingTitle>
			<form
					...
					<div className="space-y-2 text-lg w-1/2">
						...
						<input
							...
							{...register("limiteCredito", {
								...
								min: { value: 1, message: "El límite de crédito no puede ser menor a 1" },
							})}
						/>
