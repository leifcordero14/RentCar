...
import useCreateInspeccion from "../../../hooks/inspecciones/useCreateInspeccion"
import useGetVehiculos from "../../../hooks/vehiculos/useGetVehiculos"

const CreateInspeccionForm = () => {
	const { register, handleSubmit, errors } = useCreateInspeccion()
	...
	return (
		<>
			<HeadingTitle>Crear Inspección</HeadingTitle>
			<form
...
export default CreateInspeccionForm
