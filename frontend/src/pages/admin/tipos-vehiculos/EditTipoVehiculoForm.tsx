...
import useEditTipoVehiculo from "../../../hooks/tipos-vehiculos/useEditTipoVehiculo"

const EditTipoVehiculoForm = () => {
	const { register, handleSubmit, errors } = useEditTipoVehiculo()

	return (
		<>
			<HeadingTitle>Editar Tipo de Vehículo</HeadingTitle>
			<form
...
export default EditTipoVehiculoForm
