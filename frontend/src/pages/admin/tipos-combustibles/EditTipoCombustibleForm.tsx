...
import useEditTipoCombustible from "../../../hooks/tipos-combustibles/useEditTipoCombustible"

const EditTipoCombustibleForm = () => {
	const { register, handleSubmit, errors } = useEditTipoCombustible()

	return (
		<>
			<HeadingTitle>Editar Tipo de Combustible</HeadingTitle>
			<form
...
export default EditTipoCombustibleForm
