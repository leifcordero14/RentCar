...
import useEditVehiculo from "../../../hooks/vehiculos/useEditVehiculo"

const EditVehiculoForm = () => {
	const { register, handleSubmit, errors } = useEditVehiculo()
	...
	return (
		<>
			<HeadingTitle>Editar Vehículo</HeadingTitle>
			<form
...
export default EditVehiculoForm
