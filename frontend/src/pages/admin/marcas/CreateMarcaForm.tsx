...
import useCreateMarca from "../../../hooks/marcas/useCreateMarca"

const CreateMarcaForm = () => {
	const { register, handleSubmit, errors } = useCreateMarca()

	return (
		<>
			<HeadingTitle>Crear Marca</HeadingTitle>
			<form
...
export default CreateMarcaForm
