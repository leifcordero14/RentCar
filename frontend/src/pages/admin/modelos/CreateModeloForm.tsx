...
import useCreateModelo from "../../../hooks/modelos/useCreateModelo"

const CreateModeloForm = () => {
	const { register, handleSubmit, errors } = useCreateModelo()
	const { marcasQuery } = useGetMarcas("ACTIVO")

	return (
		<>
			<HeadingTitle>Crear Modelo</HeadingTitle>
			<form
...
export default CreateModeloForm
