...
import useCreateEmpleado from "../../../hooks/empleados/useCreateEmpleado"
import { validarCedula } from "../../../utils/validarCedula"

const CreateEmpleadoForm = () => {
	const { register, handleSubmit, errors } = useCreateEmpleado()

	return (
		<>
			<HeadingTitle>Crear Empleado</HeadingTitle>
			<form
