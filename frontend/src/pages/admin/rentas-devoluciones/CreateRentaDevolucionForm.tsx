...
import useCreateRentaDevolucion from "../../../hooks/rentas-devoluciones/useCreateRentaDevolucion"
import useGetVehiculos from "../../../hooks/vehiculos/useGetVehiculos"

const CreateRentaDevolucionForm = () => {
	const { register, handleSubmit, errors, watch } = useCreateRentaDevolucion()
	const { empleadosQuery } = useGetEmpleados("ACTIVO")
	const { vehiculosQuery } = useGetVehiculos("SOLICITADO")
	const { clientesQuery } = useGetClientes("ACTIVO")

	return (
		<>
			<HeadingTitle>Crear Renta y Devolución</HeadingTitle>
			<form
